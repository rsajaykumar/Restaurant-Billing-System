#include<stdio.h> //std.i/o module
#include<stdlib.h> //library module
#include<string.h>// used for handling and manipulating strings
...
//global structures, used throught the program to create linked list

struct node *headc = NULL,*newnode,*tailc = NULL;
struct node *heada = NULL, *taila = NULL;
struct node *head_s;

//options that shall be available for Admin 
void adminmenu()
{
    printf("\n\t\t\t\t\t\t\t1. View total sales\n");
...
//options that shall allow customer to choose
void customermenu()
{
    printf("\n\t\t\t\t\t\t\t1. Place your order\n");
...
//fuctions that create a node for admin's linked list
